...
.controller('CastingCtrl', function ($scope, $firebaseArray, $firebaseObject, $rootScope, $location, $routeParams) {
  ...
  var productionObj = $firebaseObject(new Firebase('https://auditionr.firebaseio.com/users/' + 
                                                   $routeParams.director_id + '/productions/' + 
                                                   $routeParams.production_id));
